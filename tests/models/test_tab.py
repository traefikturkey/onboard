...
class TestTab(unittest.TestCase):
    ...
    def test_from_dict_with_rows(self, mock_row_class, mock_from_list):
        ...
        mock_from_list.assert_called_once_with(
            mock_row_class.from_dict, dictionary["rows"]
        )

    @patch("app.models.tab.from_list")
    @patch("app.models.row.Row")
    @patch("app.models.column.Column")
    def test_from_dict_with_columns(
        self, mock_column_class, mock_row_class, mock_from_list
    ):
        ...
        mock_from_list.assert_called_once_with(
            mock_column_class.from_dict, dictionary["columns"]
        )
    ...
    @patch("app.models.row.Row")
    @patch("app.models.column.Column")
    def test_from_dict_empty_columns(
        self, mock_column_class, mock_row_class, mock_from_list
    ):
