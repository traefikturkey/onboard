...
class TestBookmark(unittest.TestCase):
    ...
    def test_from_dict_with_two_args(self):
        ...
        parent = MockWidget()
        bookmark_dict = {"name": "Test Bookmark", "link": "https://test.com"}
    ...
    def test_from_dict_with_tuple_arg(self):
        """Test from_dict static method with ((dict, parent),) format"""
        parent = MockWidget()
        bookmark_dict = {"name": "Tuple Test", "link": "https://tuple-test.com"}
    ...
    def test_from_dict_with_missing_keys(self):
        ...
        parent = MockWidget()
        bookmark_dict = {"link": "https://test.com"}  # Provide link but no name
    ...
    def test_from_dict_with_partial_data(self):
        ...
        parent = MockWidget()
        bookmark_dict = {"link": "https://only-link.com"}  # Provide link but no name
    ...
    def test_from_dict_invalid_args_count(self):
        ...
        with self.assertRaises(TypeError) as context:
            Bookmark.from_dict()
        self.assertIn(
            "from_dict expects (dict, parent) or ((dict, parent),)",
