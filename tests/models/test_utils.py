...
def test_normalize_text_and_sha_and_snake():
  ...
  assert u.to_snake_case("Some text, with punctuation!") == "some_text_with_punctuation"
...
def test_to_snake_case_edge_cases():
  ...
  assert u.to_snake_case("  multiple   spaces---and___punct ") == "multiple_spaces_and_punct"
  # underscores are removed and words joined
  assert u.to_snake_case("snake_case stays") == "snake_case_stays" or u.to_snake_case("snake_case stays") == "snake_case_stays"
